        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <Calendar className="w-6 h-6" />, title: "No-Shows", desc: "40% reduction possible with email reminders" },
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-8 rounded-lg">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" />
                    <span className="text-slate-600">Email notifications for appointments</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  <ArrowRight className="w-5 h-5 text-blue-600 mt-0.5 mr-3 flex-shrink-0" />
                  <span className="text-slate-600">Reduce no-shows by 40% with automated email reminders</span>
                </li>
                <li className="flex items-start">
                  <ArrowRight className="w-5 h-5 text-blue-600 mt-0.5 mr-3 flex-shrink-0" />
